  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-surface/50 text-foreground hover:bg-surface hover:scale-105",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:scale-105",
        ghost: "hover:bg-muted hover:text-foreground hover:scale-105",
        link: "text-primary underline-offset-4 hover:underline",
        hero: "bg-gradient-to-r from-primary to-primary-glow text-primary-foreground font-semibold hover:scale-105 hover:shadow-glow",
        glass: "glass text-foreground hover:bg-surface/30 hover:scale-105",
        gradient: "bg-gradient-to-r from-accent to-accent-glow text-accent-foreground font-semibold hover:scale-105 hover:shadow-glow",
      },
      size: {
